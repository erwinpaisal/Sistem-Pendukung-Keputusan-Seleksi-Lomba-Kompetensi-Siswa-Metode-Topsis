...
<div class="row" style="background-color: #001f3fcc; padding: 10px; border-radius: 30px">
	<div class="col-md-12">
		<div class="login-box">
			<div class="login-logo">
				<img src="dist/img/logo.png" style="width: 160px; height: 160px;" alt="">
				<br>
